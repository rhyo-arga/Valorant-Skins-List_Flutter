      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          ...
          enabledBorder: OutlineInputBorder(
            borderRadius: BorderRadius.circular(10),
            borderSide: BorderSide(
              color: (isLoginSuccess || isUsername) ? Color.fromRGBO(29, 66, 137, 1) : Color.fromRGBO(200, 16, 46, 1),
            ),
          ),
          focusedBorder: OutlineInputBorder(
            borderRadius: BorderRadius.circular(10),
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          ...
          enabledBorder: OutlineInputBorder(
            borderRadius: BorderRadius.circular(10),
            borderSide: BorderSide(
              color: (isLoginSuccess || isPassword) ? Color.fromRGBO(29, 66, 137, 1) : Color.fromRGBO(200, 16, 46, 1),
            ),
          ),
          focusedBorder: OutlineInputBorder(
            borderRadius: BorderRadius.circular(10),
